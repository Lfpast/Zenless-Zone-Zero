...
class Fairy 
{
    ...
    public:
        ...
        /*
          ...
          @param height The height of the levels
          @param width The width of the levels
          @return The pointer to the created Hollow
        */
        ...
        */
        ...
        /*
          @param filename The filename to read the level data from
          @return The pointer to the created Hollow
        */
        Hollow* readHollowFromFile(string filename = "data/level.txt") 
        {
            ifstream ifs;
            ifs.open(filename);
        ...
        */
        ...
        /*
          @param input_actions A string of input actions to simulate
          @return
        */
